...
*/
      ...
      local_image_address = image_address;
      local_mask_image_address = mask_image_address;
//#pragma omp barrier
     /*   BARRIER(Global->SlaveBarrier,num_nodes);
       

       /*Removido pois este código passará a rodar em serial*/
      ...
      //printf("foi");
      #pragma omp parallel num_threads(num_nodes) default(shared) private(i)
      {
      ...
      /*  Removido pois passará a rodar em serial*/
...
long WriteGrayscaleTIFF(char *filename, char *filename_txt, long width, long height, long scanbytes, unsigned char *data)
{
  long y;
  double factor;
  long c;
